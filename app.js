class Game {
    constructor() {
        ...
        // all of the winnihng conditions
        // an array of arrays
        ...
        // default incase player does not give their name
        this.players = {
            player1: 'Player 1',
            player2: 'Player 2'
        }
    ...
    resultValidation() {
        ...
        for (let i = 0; i <= 7; i++) {
            ...
            if (a == b && b == c) {
                ...
                // break stops the for loop (gets us out of the loop if the game is won)
            }
    ...
    playerChange() {
        ...
        // terinary operator => shortens up an if/else statement 
        this.currPlayerTurn()
    }
